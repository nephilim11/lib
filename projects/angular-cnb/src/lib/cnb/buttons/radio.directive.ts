 ...
 */
@Directive({ selector: '[cnbRadio]', providers: [RADIO_CONTROL_VALUE_ACCESSOR] })
export class ButtonRadioDirective implements ControlValueAccessor, OnInit {
  ...
  public get isActive(): boolean {
    return this.cnbRadio === this.value;
  }
  ...
  public onClick(event?: any): void {
    ...
    if (this.uncheckable && this.cnbRadio === this.value) {
      this.value = undefined;
    } else {
      this.value = this.cnbRadio;
    }
